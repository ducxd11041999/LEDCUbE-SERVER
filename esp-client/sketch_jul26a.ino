...
const char* ssid = "UIT";          //Tên mạng Wifi mà Socket server của bạn đang kết nối
const char* password = "17520355";  //Pass mạng wifi ahihi, anh em rãnh thì share pass cho mình với.
 
char host[] = "https://localhost:3000";  //Địa chỉ IP dịch vụ, hãy thay đổi nó theo địa chỉ IP Socket server của bạn.
